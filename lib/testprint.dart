...
class TestPrint {
  ...
  sample() async {
    ...
    String filename = 'flutter_black_white.png';
    ByteData bytesData =
        await rootBundle.load('assets/flutter_black_white.png');
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        ...
        bluetooth.printCustom("HEADER", 5, 1);
        bluetooth.printNewLine();
        ...
        bluetooth.printLeftRight("LEFT", "RIGHT", 6);
        bluetooth.printNewLine();
        bluetooth.print3Column("Col1", "Col2", "Col3", 7);
        bluetooth.print3Column("Col1", "Col2", "Col3", 5,
            format:
                "%-10s %10s %10s %n"); //10 is number off character from left center and right
        bluetooth.printNewLine();
        bluetooth.print4Column("Col1", "Col2", "Col3", "Col4", 5);
        bluetooth.print4Column("Col1", "Col2", "Col3", "Col4", 5,
            format: "%-8s %7s %7s %7s %n");
        bluetooth.printNewLine();
        bluetooth.printCustom("čĆžŽšŠ-H-ščđ", 12, 1, charset: "windows-1250");
        bluetooth.printLeftRight("Številka:", "18000001", 7,
            charset: "windows-1250");
        bluetooth.printCustom("Body left", 12, 1);
        bluetooth.printCustom("Body right", 12, 1);
        bluetooth.printNewLine();
        bluetooth.printCustom("Thank You", 12, 1);
        bluetooth.printNewLine();
        bluetooth.printQRcode("Insert Your Own Text to Generate", 200, 200, 20);
        bluetooth.printNewLine();
        bluetooth.printNewLine();
        bluetooth
